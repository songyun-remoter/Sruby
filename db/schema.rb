...
ActiveRecord::Schema.define(version: 20160306064218) do
  ...
  create_table "high_scores", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string   "game"
    t.integer  "score"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
